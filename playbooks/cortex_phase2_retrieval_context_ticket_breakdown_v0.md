...
| PH2-005 | Provenance + Confidence Enrichment in Context Bundles | todo | Governance Enforcement Lead | Contract/Schema Lead | Week 6 | 2026-04-03 | PH2-002,PH2-003 | `specs/cortex_project_coach_spec_v0.md`;`docs/cortex-coach/commands.md`;`contracts/` | Ensure retrieved context remains traceable with stable provenance and confidence annotations. |
