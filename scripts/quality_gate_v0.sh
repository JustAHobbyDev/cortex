...
echo "[quality-gate] 5/7 project-state boundary gate"
python3 scripts/project_state_boundary_gate_v0.py \
  --project-dir . \
  --format json >/dev/null

echo "[quality-gate] 6/7 docs and json integrity"
./scripts/ci_validate_docs_and_json_v0.sh

echo "[quality-gate] 7/7 focused coach tests"
