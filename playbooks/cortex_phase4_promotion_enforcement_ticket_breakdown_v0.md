...
|---|---|---|---|---|---|---|---|---|---|
| PH4-001 | Promotion/Enforcement Contract Baseline + Fixture Freeze | todo | Contract/Schema Lead | Governance Policy Lead | Week 11 | 2026-05-04 | PH3 complete | `contracts/promotion_enforcement_contract_v0.md`;`.cortex/reports/project_state/phase4_promotion_eval_fixture_freeze_v0.json`;`playbooks/cortex_phase4_measurement_plan_v0.md`;`specs/cortex_project_coach_spec_v0.md` | Includes Phase 3 residual-risk closeout for malformed-payload fixture pathing + contract note. |
| PH4-002 | Promotion Assistant Candidate Mapping | todo | Runtime Reliability Lead | Contract/Schema Lead | Week 11 | 2026-05-06 | PH4-001 | `cortex-coach` runtime/tests;`docs/cortex-coach/commands.md`;`specs/cortex_project_coach_spec_v0.md` | Map tactical evidence clusters into deterministic decision-candidate outputs. |
| PH4-003 | Evidence Scoring + Deterministic Candidate Ranking | todo | Runtime Reliability Lead | Governance Enforcement Lead | Week 11 | 2026-05-08 | PH4-001,PH4-002 | `scripts/phase4_promotion_candidate_harness_v0.py`;`.cortex/reports/project_state/phase4_promotion_candidate_quality_report_v0.json`;`.cortex/reports/project_state/phase4_promotion_determinism_report_v0.json` | Scoring is bounded, explainable, and deterministic across repeated runs. |
| PH4-004 | Enforcement Ladder Integration for Unlinked Closure Blocking | todo | Governance Enforcement Lead | CI/Gate Owner | Week 11 | 2026-05-10 | PH4-001,PH4-002 | `scripts/reflection_enforcement_gate_v0.py`;`scripts/quality_gate_v0.sh`;`scripts/quality_gate_ci_v0.sh`;`.cortex/reports/project_state/phase4_enforcement_blocking_report_v0.json` | Block governance-impact tactical closure attempts lacking required linkage. |
| PH4-005 | Governance Debt Visibility (Ready/Blocked Governance Actions) | todo | Governance Enforcement Lead | Program Lead | Week 12 | 2026-05-12 | PH4-004 | `scripts/phase4_governance_debt_harness_v0.py`;`.cortex/reports/project_state/phase4_governance_debt_visibility_report_v0.json`;`docs/cortex-coach/commands.md` | Publish deterministic debt view for owner/action-oriented remediation queues. |
| PH4-006 | Governance Non-Regression Under Promotion Flow | todo | Conformance QA Lead | Governance Policy Lead | Week 12 | 2026-05-14 | PH4-003,PH4-004,PH4-005 | `scripts/phase4_promotion_governance_regression_harness_v0.py`;`.cortex/reports/project_state/phase4_governance_regression_report_v0.md` | Required governance gates must remain pass under promotion-assisted flows. |
| PH4-007 | Promotion Path Latency/Budget + CI Overhead Hardening | todo | CI/Gate Owner | Runtime Reliability Lead | Week 12 | 2026-05-16 | PH4-003,PH4-004 | `scripts/phase4_promotion_performance_pack_v0.py`;`.cortex/reports/project_state/phase4_latency_report_v0.json`;`.cortex/reports/project_state/phase4_ci_overhead_report_v0.json` | Includes standalone parity closeout and weekly CI-overhead tracking guardrails from Phase 3 residual-risk registry. |
