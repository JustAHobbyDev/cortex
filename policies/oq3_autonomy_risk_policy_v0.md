...
3. cross-scope writes that touch `specs/`, `scene/authority/`, gate surfaces, or span multi-project scope
...
- High impact: activating a spec; changing a gate state; writing across project scopes including `specs/`.
