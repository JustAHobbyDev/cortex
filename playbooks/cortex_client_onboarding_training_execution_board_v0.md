...
| CT-004 | Module Lab Guide Pack (`M2`-`M5`) | todo | Delivery Operations Lead | Runtime Reliability Lead | 2026-03-07 | CT-002,CT-003 | `docs/cortex-coach/client_training_labs_v0.md` | Must include deterministic command checklists and expected artifact outputs. |
| CT-005 | Internal Pilot Completion + Calibration Report | todo | Program Lead | Maintainer Council | 2026-03-14 | CT-004 | `.cortex/reports/project_state/client_onboarding_pilot_calibration_report_v0.md` | Validate timing, failure modes, and rubric thresholds using one reference project. |
| CT-006 | Certification Workflow Automation + Recurring Cadence | todo | Conformance QA Lead | CI/Gate Owner | 2026-03-21 | CT-005 | `scripts/client_onboarding_certification_pack_v0.py`;`.cortex/reports/project_state/client_onboarding_certification_pack_v0.json`;`playbooks/session_governance_hybrid_plan_v0.md` | Wire scorecard generation and recurring post-onboarding governance cadence checks. |
