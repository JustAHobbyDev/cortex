...
| PH6-007 | External Pilot Validation | done | Program Lead | Delivery Operations Lead | Week 18 | 2026-06-24 | - | `scripts/phase6_external_pilot_harness_v0.py`;`.cortex/reports/project_state/phase6_external_pilot_report_v0.md`;`.cortex/reports/project_state/phase6_external_pilot_report_v0.json` | Deterministic pilot harness validates bootstrap portability on two non-Cortex seed repos (`python_api_service` and `node_dashboard_app`); hydration requires seeded governance capsule bundle and then passes. |
