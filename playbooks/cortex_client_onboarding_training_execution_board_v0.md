...
| CT-006 | Certification Workflow Automation + Recurring Cadence | todo | Conformance QA Lead | CI/Gate Owner | 2026-03-21 | CT-005 remediation items (command preflight + bootstrap controls) | `scripts/client_onboarding_certification_pack_v0.py`;`.cortex/reports/project_state/client_onboarding_certification_pack_v0.json`;`playbooks/session_governance_hybrid_plan_v0.md` | Wire scorecard generation and recurring post-onboarding governance cadence checks, including pilot remediation controls. |
