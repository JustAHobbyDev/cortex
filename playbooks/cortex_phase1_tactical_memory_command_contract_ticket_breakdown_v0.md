...
Evidence:
- Prime contract section and bundle schema committed.
...
Evidence:
- Diff/prune contracts and policy linkage committed.
...
Evidence:
- Storage/locking contract section committed with deterministic examples.
