...
| CT-005 | Internal Pilot Completion + Calibration Report | todo | Program Lead | Maintainer Council | 2026-03-14 | - | `.cortex/reports/project_state/client_onboarding_pilot_calibration_report_v0.md` | Validate timing, failure modes, and rubric thresholds using one reference project. |
