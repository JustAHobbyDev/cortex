...
|---|---|---|---|---|---|---|---|---|---|
| PH5-001 | Rollout Mode Contract + Policy Baseline (`off`,`experimental`,`default`) | todo | Governance Policy Lead | Maintainer Council | Week 13 | 2026-05-18 | PH4 complete | `contracts/rollout_mode_contract_v0.md`;`policies/rollout_mode_policy_v0.md`;`specs/cortex_project_coach_spec_v0.md`;`playbooks/cortex_phase5_measurement_plan_v0.md` | Defines mode semantics, transition preconditions, rollback rules, and decision-tracking requirements. |
